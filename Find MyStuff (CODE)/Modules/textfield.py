...
__all__ = ("CustomTextField", "MDTextFieldRect", "MDTextFieldRound")
...
<CustomTextField>
    ...
    font_name: "Poppins" if not root.font_name else root.font_name
...
class CustomTextField(ThemableBehavior, TextInput):
    font_name = StringProperty('Poppins')
