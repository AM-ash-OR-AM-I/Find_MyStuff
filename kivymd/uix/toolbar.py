...
class MDToolbar(NotchedBox):
    ...
    def __init__(self, **kwargs):
        ...
        self.theme_cls.bind(theme_style=self.update_action_bar_text_colors)
    ...
    def update_md_bg_color(self, *args):
        self.md_bg_color = self.theme_cls._get_primary_color() if not self.theme_cls.theme_style=='Dark' else get_color_from_hex(colors['Dark']['CardsDialogs'])
